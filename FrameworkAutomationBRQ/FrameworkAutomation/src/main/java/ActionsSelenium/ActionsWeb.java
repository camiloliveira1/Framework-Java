...
import TestBaseSelenium.TestBase;
	...
	/////FUNCIONALIDADES DE AÇÕES (STEPS)/////
		...
		//Verificar se a grid contém e apenas se contém um valor determinado.
		public void searchValueGrid(String byelement, String element, String searchValue) throws IOException{
			...
			{				
				...
				if (verf != true){
					AssertStep(false,"Valor "+searchValue +" NÃO encntrado na Grid :"+ "'"+element+"'");
				}
			}catch (Exception e){
		...
		public void assertValues(String byelement, String element, String expected) throws IOException{
			...
			try{
				...
				focusElement();
					...
					{
						AssertStep(false,"<html>Elemento não localizado: <br/>"+e +"</html>");
					}
